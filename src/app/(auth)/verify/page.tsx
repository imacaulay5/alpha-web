...
export default function VerifyPage() {
  ...
  const verificationType = useMemo(() => {
    ...
    if (raw === 'signup' || raw === 'email' || raw === 'magiclink' || raw === 'recovery' || raw === 'invite' || raw === 'email_change') {
      return raw
    }
    return 'signup'
  }, [searchParams])
  ...
  useEffect(() => {
    ...
    const storedEmail = typeof window !== 'undefined' ? window.sessionStorage.getItem('pendingVerificationEmail') : null
